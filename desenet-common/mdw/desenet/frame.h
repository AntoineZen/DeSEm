...
namespace desenet {
    ...
    public:
        /**
         * @brief Nrf24 frame header: Destination address (4 bytes) + payload length (1 byte)
         *
         ...
         */
        static constexpr SharedByteBuffer::sizeType Mtu = HEADER_SIZE + 64;
